Title: Nemoclaw Slack Bot Lessons Learned
Date: 2026-05-11
Category: Tutorials
Tags: NemoClaw, Slack, AI-agents, bots, developer-tools, beginner-guide, lessons-learned
Slug: nemoclaw-slack-bot-lessons-learned
---
...
- `im:write` ✅
- `users:read` ✅
- `files:write` ✅ (added it just in case — why not?)
